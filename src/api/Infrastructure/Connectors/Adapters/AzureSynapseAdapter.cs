...
/// <summary>WO-48: stub adapter for azure-synapse (MVP — returns empty results).</summary>
public sealed class AzureSynapseAdapter : IConnectorAdapter
{
    public string ConnectorTypeId => "azure-synapse";
    ...
    public NormalizedEvent NormalizeEvent(string rawPayload, string connectorId, string tenantId)
        => new() { EventType = "azure-synapse", ConnectorId = connectorId, TenantId = tenantId, Payload = rawPayload };
}
