...
/// <summary>WO-48: stub adapter for sqlserver (MVP — returns empty results).</summary>
public sealed class SqlServerAdapter : IConnectorAdapter
{
    public string ConnectorTypeId => "sqlserver";
